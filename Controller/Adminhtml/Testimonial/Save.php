<?php
namespace Ahromets\Testimonials\Controller\Adminhtml\Testimonial;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Ahromets_Testimonials::save');
    }
    ...
    public function execute()
    {
        ...
        if ($data) {
            /** @var \Ahromets\Testimonials\Model\Testimonial $model */
            $model = $this->_objectManager->create('Ahromets\Testimonials\Model\Testimonial');
            ...
            $this->_eventManager->dispatch(
                'testimonials_testimonial_prepare_save',
