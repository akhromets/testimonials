<?php
namespace Ahromets\Testimonials\Block\Adminhtml\Testimonial;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Ahromets_Testimonials';
        $this->_controller = 'adminhtml_testimonial';

        parent::_construct();

        if ($this->_isAllowedAction('Ahromets_Testimonials::save')) {
        ...
        if ($this->_isAllowedAction('Ahromets_Testimonials::testimonial_delete')) {
